...
public class Invest implements Parcelable {
	...
	public Invest(Long investId, Long userId, String investDate,
			...
			Double interestRateMax, int repaymentType, int guaranteeType,
	...
	public Invest(Cursor cursor) {
		...
		this.repaymentType = cursor.getInt(cursor
				.getColumnIndex("repayment_type"));
		this.guaranteeType = cursor.getInt(cursor
	...
	private Invest(Parcel in) {
		...
		repaymentType = in.readInt();
		guaranteeType = in.readInt();
